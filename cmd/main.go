...
func init() {
	...
	utilruntime.Must(uptimekumav1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "445cd210.aleix.cloud",
	...
	kumaHost := os.Getenv("KUMA_API_HOST")
	kumaUser := os.Getenv("KUMA_API_USER")
	kumaPassword := os.Getenv("KUMA_API_PASSWORD")

	api, err := uptimekumaapi.NewUptimeKumaAPI(kumaHost, kumaUser, kumaPassword)
